...
const logoAsset =
  "https://raw.githubusercontent.com/contatoyvesx/monteiro/main/src/assets/monteiro.png";
import {
  FloatingWhatsApp,
  PHONE_DISPLAY,
  Reveal,
...
function Index() {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-20 sm:py-28 lg:py-36">
          <div className="max-w-2xl">
            ...
            <h1 className="rise mt-6 text-4xl font-extrabold uppercase leading-[1.02] text-white sm:text-5xl lg:text-6xl">
              Sua mudança com{" "}
              <span className="text-gold">segurança</span>, cuidado e confiança.
            </h1>

            <p className="rise mt-6 max-w-xl text-base leading-relaxed text-white/80 sm:text-lg">
              Transportamos seus móveis e pertences com responsabilidade, do
              seu endereço até o novo destino.
            </p>
            ...
            {services.map((s, i) => (
              <Reveal key={s.title} delay={i * 90}>
                <article className="group h-full rounded-2xl border border-border bg-card p-7 transition-all duration-300 hover:-translate-y-1.5 hover:border-gold/60 hover:shadow-[0_24px_50px_-30px_var(--navy)]">
                  ...
                  <h3 className="mt-6 text-xl font-extrabold uppercase text-navy-deep">
                    {s.title}
                  </h3>
      ...
      <section
        id="sobre"
        className="relative bg-navy-deep py-20 sm:py-28"
      >
        <div className="mx-auto max-w-6xl px-4">
          <Reveal>
            <SectionTitle
            ...
            {steps.map((s, i) => (
              <Reveal key={s.n} delay={i * 110}>
                <div className="relative h-full overflow-hidden rounded-2xl border border-border bg-card p-8">
                  <span className="font-display text-5xl font-extrabold text-gold/35">
                    {s.n}
                  </span>

                  <h3 className="mt-3 text-xl font-extrabold uppercase text-navy-deep">
                    {s.title}
                  </h3>
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 lg:grid-cols-2">
          <Reveal>
            ...
            <p className="mt-6 text-base leading-relaxed text-muted-foreground">
              Realizamos mudanças residenciais, comerciais e transporte de
              móveis em São Paulo e região. Não encontrou a sua cidade? Fale
              conosco pelo WhatsApp e confirmamos o atendimento.
            </p>
      ...
      <section
        id="contato"
        className="relative isolate overflow-hidden bg-navy py-20 sm:py-28"
      >
        <div
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center">
          <Reveal>
            ...
            <p className="mt-6 text-base text-white/75 sm:text-lg">
              Fale com a Monteiro Transportes e Mudanças e solicite seu
              orçamento.
            </p>
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 md:grid-cols-3">
          <div>
            ...
            <p className="mt-5 max-w-xs text-sm leading-relaxed">
              Mudanças residenciais, comerciais, pequenas mudanças e transporte
              de móveis com segurança e responsabilidade.
            </p>
          </div>
