...
const reasons = [
  ...
  },
  {
    ...
    text: "Cargas acomodadas e fixadas com critério do início ao fim.",
  },
  {
    icon: Sparkles,
    title: "Cuidado com seus pertences",
    text: "Móveis e objetos manuseados com atenção em cada etapa.",
  },
  {
    icon: Clock,
    title: "Pontualidade",
...
const steps = [
  ...
  },
  {
    ...
    text: "Conte de onde será a mudança, destino e o que precisa transportar.",
  },
  {
    n: "03",
    title: "Nós cuidamos do transporte",
    text: "A equipe realiza o serviço com cuidado e segurança.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-secondary py-20 sm:py-28">
        <div className="mx-auto max-w-6xl px-4">
          <Reveal>
            <SectionTitle eyebrow="Como funciona" title="Três passos para a sua mudança" />
          </Reveal>
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 lg:grid-cols-2">
          <Reveal>
            ...
            <p className="mt-6 text-base leading-relaxed text-muted-foreground">
              Realizamos mudanças residenciais, comerciais e transporte de móveis em São Paulo e região. Não encontrou a sua cidade? Fale conosco pelo WhatsApp e confirmamos o atendimento.
            </p>
            <ul className="mt-7 flex flex-wrap gap-3">
              {["São Paulo", "Região metropolitana"].map((c) => (
                <li key={c} className="inline-flex items-center gap-2 rounded-full border border-navy/15 bg-secondary px-4 py-2 font-display text-sm font-bold uppercase tracking-wide text-navy">
      ...
      <section id="contato" className="relative isolate overflow-hidden bg-navy py-20 sm:py-28">
        <div
          ...
          style={{
            backgroundImage: "repeating-linear-gradient(135deg, var(--gold) 0 2px, transparent 2px 26px)",
          }}
        />
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 md:grid-cols-3">
          <div>
            ...
            <p className="mt-5 max-w-xs text-sm leading-relaxed">
              Mudanças residenciais, comerciais, pequenas mudanças e transporte de móveis com segurança e responsabilidade.
            </p>
          </div>
